...
namespace _07_Print_All_Minion_Names
{
    class Program
    {
        ...
        {
            using SqlConnection minionsDB = new SqlConnection(@"Server =.\SQLEXPRESS;Database=MinionsDB;Integrated Security=true");
            ...
            SqlCommand getMinionNamesCommand = new SqlCommand(getMinionNamesQuery, minionsDB);
